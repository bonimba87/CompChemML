...
<p align="center">
  <img src="./RNN_SMILES/results/Some_generated_molecules.png" width="600"/>
  <br>
  <em> Novel molecules generated by autoregressive sampling from the RNN. Each is labeled by its QED factor. </em>
</p>
